                        ...
                        <div className="flex items-center justify-between flex-wrap gap-3">
                            ...
                            <div className="flex items-center gap-2 text-xs">
                                ...
                                <button
                                    ...
                                    className={`relative w-11 h-6 rounded-full transition-colors duration-200 flex items-center px-1 ${useLocal ? 'bg-green-600' : 'bg-blue-600'}`}
                                >
                                    <span className={`w-4 h-4 rounded-full bg-white shadow transition-transform duration-200 ${useLocal ? 'translate-x-5' : 'translate-x-0'}`} />
                                </button>
